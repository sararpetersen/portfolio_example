...
For most of the time I've been building [Steady](/steady), the only person using it has been me. That's normal for a personal project— you build it, you refine it, you use it yourself, you refine it again. What's less normal is how long I let that loop run before asking anyone else to actually try it. I finally have, and it's been sitting with me since.
