...
This was one of those updates I kept putting off because I knew the migration would be messy, and it would be a long process. Now that it’s done, the site feels much more stable, the blog is easier to update, and the frontpage behaves exactly the way I actually want it to. If you’re reading this while the site is still a work in progress, consider this the note that explains what I fixed most recently.
